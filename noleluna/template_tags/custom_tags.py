# Code taken from https://djangosnippets.org/snippets/967/
...
def do_switch(parser, token):
    """
    {% switch %} tag compares a variable against one or more values in {% case %} tags and outputs matching contents.
    An optional {% else %} tag sets off the default output if no matches could be found:
    ...
    class BlockTagList(object):
        # A bit of a hack. It embeds knowledge of the behaviour of Parser.parse() relating to the "parse_until" argument
